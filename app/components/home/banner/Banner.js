...
export default function Banner() {
  return (
    <section className="container pb-12 md:py-16 grid grid-cols-12 gap-0 lg:gap-10">
      {/* banner left section */}
      ...
      <div className="relative col-span-12 lg:col-span-7 flex items-start justify-end order-1 lg:order-2">
        <Image
          src={Bot1}
          alt="Robot"
